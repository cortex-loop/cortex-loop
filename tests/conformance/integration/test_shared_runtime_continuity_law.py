...
_REFERENCE_FIRST_FEEDBACK_WINDOW = {
    "window_size": 1,
    "rejection_count": 0,
    "override_count": 0,
    "latched_count": 0,
...
_STREAM_HOST_FIRST_FEEDBACK_WINDOW = {
    **_REFERENCE_FIRST_FEEDBACK_WINDOW,
    "stream_only_progress_count": 1,
    "goal_progress_floor": 0.3,
    "recent_evidence_progress_class": "token-stream",
}
_REFERENCE_SECOND_FEEDBACK_WINDOW_MOVED = {
    "window_size": 2,
    "rejection_count": 0,
    "override_count": 0,
    "latched_count": 0,
    ...
    "goal_progress_floor": 0.0,
    "degradation_pressure_bonus": 0,
    "recent_evidence_progress_class": "candidate",
    "recent_continuity_progress_class": "returned-to-main",
    "sustained_spike_flags": [],
}
_STREAM_HOST_SECOND_FEEDBACK_WINDOW_MOVED = {
    **_REFERENCE_SECOND_FEEDBACK_WINDOW_MOVED,
    "stream_only_progress_count": 1,
    "recent_evidence_progress_class": "commitment",
}
_REFERENCE_THIRD_FEEDBACK_WINDOW_MOVED = {
    "window_size": 3,
    "rejection_count": 0,
    "override_count": 0,
    "latched_count": 0,
    ...
    "degradation_pressure_bonus": 0,
    "recent_evidence_progress_class": "none",
    "recent_continuity_progress_class": "pending-goals-reduced",
    "sustained_spike_flags": [],
}
_STREAM_HOST_THIRD_FEEDBACK_WINDOW_MOVED = {
    **_REFERENCE_THIRD_FEEDBACK_WINDOW_MOVED,
    "stream_only_progress_count": 1,
    "recent_evidence_progress_class": "token-stream",
}
_REFERENCE_FOURTH_FEEDBACK_WINDOW_MOVED = {
    "window_size": 3,
    "rejection_count": 0,
    "override_count": 0,
    "latched_count": 0,
    "clean_success_streak": 0,
    "evidence_state_move_count": 2,
    "meaningful_evidence_progress_count": 2,
    "stream_only_progress_count": 0,
    "continuity_improvement_count": 3,
    "family_change_without_evidence_count": 0,
    "same_family_no_progress_count": 0,
    "same_context_retry_count": 0,
    "goal_progress_floor": 0.0,
...
_REFERENCE_SECOND_FEEDBACK_WINDOW_REJECTED = {
    "window_size": 2,
    "rejection_count": 1,
    "override_count": 0,
    "latched_count": 0,
    ...
    "recent_evidence_progress_class": "none",
    "recent_continuity_progress_class": "none",
    "sustained_spike_flags": ["prior-continuity-rejection"],
}
_STREAM_HOST_SECOND_FEEDBACK_WINDOW_REJECTED = {
    **_REFERENCE_SECOND_FEEDBACK_WINDOW_REJECTED,
    "stream_only_progress_count": 2,
    ...
    "openai": _RuntimeHostSpec(
        ...
        continuity_projection=(
            {
                ...
                "pending_goal_refs": [],
                "feedback_window_summary": _STREAM_HOST_FIRST_FEEDBACK_WINDOW,
            ...
            },
            {
                ...
                "feedback_window_summary": _STREAM_HOST_SECOND_FEEDBACK_WINDOW_MOVED,
            ...
            },
            {
                ...
                "active_track_ref": "branch-alpha",
                "pending_goal_refs": [],
                "feedback_window_summary": _STREAM_HOST_THIRD_FEEDBACK_WINDOW_MOVED,
                "closure_required": False,
                "closure_reason_tags": [],
            },
            {
                ...
                "active_track_ref": "main",
                "pending_goal_refs": [],
                "feedback_window_summary": _REFERENCE_FOURTH_FEEDBACK_WINDOW_MOVED,
                "closure_required": False,
                "closure_reason_tags": [],
            },
        ),
        rejection_projection=(
            ...
            },
            {
                ...
                "active_track_ref": "branch-alpha",
                "pending_goal_refs": [],
                "feedback_window_summary": _STREAM_HOST_SECOND_FEEDBACK_WINDOW_REJECTED,
                "closure_required": True,
                "closure_reason_tags": [
    ...
    "reference": _RuntimeHostSpec(
        ...
        continuity_projection=(
            {
                ...
                "active_track_ref": "branch-alpha",
                "pending_goal_refs": [],
                "feedback_window_summary": _REFERENCE_FIRST_FEEDBACK_WINDOW,
                "closure_required": False,
                "closure_reason_tags": [],
            },
            {
                ...
                "active_track_ref": "main",
                "pending_goal_refs": ["branch-alpha"],
                "feedback_window_summary": _REFERENCE_SECOND_FEEDBACK_WINDOW_MOVED,
                "closure_required": True,
                "closure_reason_tags": ["continuity_reminder", "pending_goal_debt"],
            },
            {
                ...
                "active_track_ref": "branch-alpha",
                "pending_goal_refs": [],
                "feedback_window_summary": _REFERENCE_THIRD_FEEDBACK_WINDOW_MOVED,
                "closure_required": False,
                "closure_reason_tags": [],
            },
            {
        ...
        rejection_projection=(
            ...
            },
            {
                ...
                "active_track_ref": "branch-alpha",
                "pending_goal_refs": [],
                "feedback_window_summary": _REFERENCE_SECOND_FEEDBACK_WINDOW_REJECTED,
                "closure_required": True,
                "closure_reason_tags": [
                    "continuity_rejection",
                    "continuity_reminder",
