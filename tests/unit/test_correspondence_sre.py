...
EXPECTATIONS = (
    ...
    SreCorrespondenceExpectation(
        row_label="TrustedStructure",
        module_path="cortex.sre.preservation",
        symbol_name="TrustedStructure",
        promised_surfaces=(
            PromisedTestSurface(
                test_file="tests/unit/test_preservation_state.py",
                test_names=(
                    "test_preservation_state_payload_roundtrip_preserves_sorted_fact_sets",
                    "test_derive_preservation_state_for_clean_pass_sets_continue_and_trusted_structure",
                ),
            ),
        ),
    ),
    SreCorrespondenceExpectation(
        row_label="FalsifiedStructure",
        module_path="cortex.sre.preservation",
        symbol_name="FalsifiedStructure",
        promised_surfaces=(
            PromisedTestSurface(
                test_file="tests/unit/test_preservation_state.py",
                test_names=(
                    "test_preservation_state_payload_roundtrip_preserves_sorted_fact_sets",
                    "test_derive_preservation_state_for_blocked_outcomes_sets_non_repair_moves",
                ),
            ),
        ),
    ),
    SreCorrespondenceExpectation(
        row_label="InterventionBudget",
        module_path="cortex.sre.preservation",
        symbol_name="InterventionBudget",
        promised_surfaces=(
            PromisedTestSurface(
                test_file="tests/unit/test_preservation_state.py",
                test_names=(
                    "test_preservation_state_payload_roundtrip_preserves_sorted_fact_sets",
                    "test_derive_preservation_state_for_pytest_failure_preserves_failing_tests_and_zero_budget_stops",
                ),
            ),
        ),
    ),
    SreCorrespondenceExpectation(
        row_label="PreservationState",
        module_path="cortex.sre.preservation",
        symbol_name="PreservationState",
        promised_surfaces=(
            PromisedTestSurface(
                test_file="tests/unit/test_preservation_state.py",
                test_names=("test_preservation_state_payload_roundtrip_preserves_sorted_fact_sets",),
            ),
            PromisedTestSurface(
                test_file="tests/unit/test_openai_runtime_step.py",
                test_names=("test_openai_runtime_verification_step_updates_runtime_truth_from_external_failure",),
            ),
        ),
    ),
    SreCorrespondenceExpectation(
        row_label="derive_preservation_state",
        module_path="cortex.sre.preservation",
        symbol_name="derive_preservation_state",
        promised_surfaces=(
            PromisedTestSurface(
                test_file="tests/unit/test_preservation_state.py",
                test_names=(
                    "test_derive_preservation_state_for_clean_pass_sets_continue_and_trusted_structure",
                    "test_derive_preservation_state_for_import_failure_narrows_to_parsed_paths",
                    "test_derive_preservation_state_parse_invalid_without_paths_falls_back_to_allowed_surface",
                ),
            ),
        ),
    ),
    SreCorrespondenceExpectation(
        row_label="choose_preservation_move",
        module_path="cortex.sre.preservation",
        symbol_name="choose_preservation_move",
        promised_surfaces=(
            PromisedTestSurface(
                test_file="tests/unit/test_preservation_state.py",
                test_names=(
