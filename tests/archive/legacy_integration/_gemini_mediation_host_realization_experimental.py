"""Build or emit the experimental Gemini-host mediated host-realization comparator."""
...
from tests.archive.legacy_integration._gemini_lane_packet_example import (
    build_gemini_lane_packet_example_snapshot,
)
from tests.archive.legacy_integration._gemini_mediated_lane_packet_example import (
    build_gemini_host_realization_specialization_snapshot,
    build_gemini_mediated_lane_packet_example_snapshot,
)
...
def build_gemini_host_realization_mediated_packet(
    ...
    return build_reference_mediation_packet(
        ...
        run_outputs={
            "outcome_summary": (
                "The mediated Gemini-host path preserves the same certified "
            ...
            "host_realization_summary": (
                "Gemini-host realization keeps the same selected family "
        ...
        lift_axis_notes={
            "Reduced Thrashing": (
                "This mediated packet is part of the committed Gemini "
            ...
            "Better Host-Specialized Realization": (
                ...
                "Gemini `current-pair` publication surface.",
