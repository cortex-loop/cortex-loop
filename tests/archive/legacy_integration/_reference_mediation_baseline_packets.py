...
from tests.conformance.integration._reference_lane_packet_example import (
    build_reference_lane_packet_example_snapshot,
)
from tests.archive.legacy_integration._reference_mediated_lane_packet_example import (
...
from tests.archive.legacy_integration._reference_mediation_thrash_burden import (
...
_SCOPE_TEXT = {
    ...
    ("scenario_host_openai_01", "experimental_mediated"): (
        "This committed run packet records one OpenAI-host experimental mediated "
        "host-realization comparator within the committed OpenAI host-realization "
        "paired-run series for mediation evidence review.\n"
