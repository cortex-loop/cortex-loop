"""Integration test for the committed Claude-lane packet example."""
...
def test_claude_lane_current_pair_packet_example_matches_committed_doc() -> None:
    expected_snapshot = _load_committed_snapshot()
    actual_snapshot = build_claude_lane_packet_example_snapshot()
