"""Integration tests for Gemini service continuity over loopback HTTP."""
...
from tests.integration._gemini_service_harness import run_gemini_service
...
def test_gemini_service_export_import_preserves_g3_equivalence_and_keeps_diagnostics_non_equivalent(
    ...
    with run_gemini_service() as first_service:
        first_records = [
    ...
    with run_gemini_service() as second_service:
