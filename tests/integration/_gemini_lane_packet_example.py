...
def build_gemini_lane_packet_example_snapshot() -> dict[str, object]:
    ...
    candidate_result = evaluate_gemini_host_commitment(
        "content.delta",
        {
            "interaction": {"id": "gemini-host-packet-session-1"},
            "session_id": "gemini-host-packet-session-1",
            "candidate_id": "gemini-host-packet-candidate-1",
            "stop_fields": {"claim_id": "gemini-host-packet-candidate-1"},
        },
    ...
    result = evaluate_gemini_host_commitment(
        ...
        environment_handle=gemini_environment_handle(),
        provenance_manifest=provenance_manifest_for("gemini-host-artifact-1"),
