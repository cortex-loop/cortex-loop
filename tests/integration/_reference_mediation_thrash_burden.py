"""Build reference-only AUX burden artifacts for thrash mediation evidence."""
...
def build_reference_thrash_burden_artifact(
    *,
    pair_id: str,
    pair_key: str,
    run_id: str,
    ...
    burden = AuxBurdenReport(
        ...
        metadata=(
            MetadataField("scenario_id", "scenario_thrash_reference_01"),
...
def render_reference_thrash_burden_artifact(
    relative_path: str,
...
def emit_reference_thrash_burden_artifacts(
    ...
    for index, (relative_path, builder) in enumerate(builders.items()):
        ...
        sys.stdout.write(render_reference_thrash_burden_artifact(relative_path, builder()))
...
def _scope_text(variant: str) -> str:
    if variant == "baseline_non_mediated":
        return (
            ...
            "thrash burden measurement within the committed thrash paired-run series for "
    ...
    return (
        ...
        "mediated thrash burden measurement within the committed thrash paired-run "
