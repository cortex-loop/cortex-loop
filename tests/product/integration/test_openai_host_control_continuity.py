...
from tests.product.integration._openai_service_harness import run_openai_service
...
def test_openai_host_control_export_import_preserves_control_truth() -> None:
    ...
    assert "continuity_truth" not in split_artifact
    assert "control_residue" not in split_artifact
