...
revalidate-gemini-runtime:
	$(PYTEST) tests/unit/test_gemini_runtime_session_io.py -q
	$(PYTEST) tests/unit/test_gemini_runtime_step.py -q
	$(PYTEST) tests/unit/test_gemini_runtime_ownership.py -q
	$(PYTEST) tests/integration/test_gemini_runtime_cli.py -q
	$(PYTEST) tests/integration/test_gemini_runtime_continuity.py -q

revalidate-gemini-ingress:
	$(PYTEST) tests/unit/test_gemini_ingress.py -q
	$(PYTEST) tests/integration/test_gemini_ingress_cli.py -q
	$(PYTEST) tests/integration/test_gemini_ingress_continuity.py -q
...
revalidate-gemini-host-control:
	$(PYTEST) tests/unit/test_gemini_host_control.py -q
	$(PYTEST) tests/integration/test_gemini_host_control_service.py -q
	$(PYTEST) tests/integration/test_gemini_host_control_continuity.py -q

revalidate-claude-runtime:
	$(PYTEST) tests/unit/test_claude_runtime_session_io.py -q
	$(PYTEST) tests/unit/test_claude_runtime_step.py -q
	$(PYTEST) tests/unit/test_claude_runtime_ownership.py -q
	$(PYTEST) tests/integration/test_claude_runtime_cli.py -q
	$(PYTEST) tests/integration/test_claude_runtime_continuity.py -q

revalidate-claude-ingress:
	$(PYTEST) tests/unit/test_claude_ingress.py -q
	$(PYTEST) tests/integration/test_claude_ingress_cli.py -q
	$(PYTEST) tests/integration/test_claude_ingress_continuity.py -q

revalidate-claude-service:
	$(PYTEST) tests/unit/test_claude_service.py -q
	$(PYTEST) tests/integration/test_claude_service_http.py -q
	$(PYTEST) tests/integration/test_claude_service_continuity.py -q

revalidate-claude-host-control:
	$(PYTEST) tests/unit/test_claude_host_control.py -q
	$(PYTEST) tests/integration/test_claude_host_control_service.py -q
	$(PYTEST) tests/integration/test_claude_host_control_continuity.py -q
...
live-provider-baselines-automation:
	$(PYTHON) tools/live_provider_baselines.py --lane automation

live-host-native-product-paths:
	$(PYTHON) tools/live_host_native_product_paths.py

live-openai-app-server:
	$(PYTHON) tools/live_openai_app_server_operator.py

live-cortex-host-control:
	$(PYTHON) tools/live_cortex_host_control.py --lane automation

live-compare:
	$(PYTHON) tools/live_compare.py

conformance-preflight:
	$(PYTHON) tools/cortex_conformance.py --mode preflight

conformance-fast:
	$(PYTHON) tools/cortex_conformance.py --mode fast --contract-pack verified_work_bookmarks_v1

conformance-active:
	$(PYTHON) tools/cortex_conformance.py --mode active --contract-pack verified_work_bookmarks_v1

live-operator-payoff-audit:
	$(PYTHON) tools/live_operator_payoff_audit.py

live-operator-directionality:
	$(PYTHON) tools/live_operator_directionality.py

live-operator-directionality-audit:
	$(PYTHON) tools/live_operator_directionality_audit.py
...
revalidate-mediation-branch-discipline:
	$(PYTEST) tests/unit/test_mediation_reference_branch_discipline_basis.py -q
	$(PYTEST) tests/unit/test_mediation_openai_branch_discipline_basis.py -q
	$(PYTEST) tests/unit/test_mediation_claude_branch_discipline_basis.py -q
	$(PYTEST) tests/integration/test_reference_mediated_branch_discipline_comparator.py -q
	$(PYTEST) tests/integration/test_openai_mediated_branch_discipline_comparator.py -q
	$(PYTEST) tests/integration/test_claude_mediated_branch_discipline_comparator.py -q

revalidate-mediation-non-thrash-burden:
	$(PYTEST) tests/unit/test_mediation_reference_non_thrash_burden_basis.py -q
	$(PYTEST) tests/unit/test_mediation_openai_non_thrash_burden_basis.py -q
	$(PYTEST) tests/unit/test_mediation_claude_non_thrash_burden_basis.py -q
	$(PYTEST) tests/integration/test_reference_mediated_non_thrash_burden_comparator.py -q
	$(PYTEST) tests/integration/test_openai_mediated_non_thrash_burden_comparator.py -q
	$(PYTEST) tests/integration/test_claude_mediated_non_thrash_burden_comparator.py -q

revalidate-mediation-claude-host-realization:
	$(PYTEST) tests/unit/test_mediation_claude_host_realization_basis.py -q
	$(PYTEST) tests/integration/test_claude_lane_packet_example.py -q
	$(PYTEST) tests/integration/test_claude_mediated_lane_packet_example.py -q
	$(PYTEST) tests/integration/test_claude_mediated_host_realization_comparator.py -q

revalidate-mediation-claude-uncertainty:
	@echo "revalidate-mediation-claude-uncertainty: no committed Claude uncertainty package on the current line"
...
revalidate-mediation-justification:
	$(MAKE) revalidate-mediation-evidence
	$(PYTEST) tests/unit/test_verification_docs_sync.py -q
