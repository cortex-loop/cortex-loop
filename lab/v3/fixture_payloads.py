"""Deterministic passing verified-work payloads for V3 fixture mode."""

from __future__ import annotations


_BOOKMARKS_APP_TEMPLATE_RESULT = """=== FILE: src/bookmarks_api/main.py ===
from __future__ import annotations
...
_PROJECT_TEMPLATE_RESULT = """=== FILE: src/normalize_port.py ===
from __future__ import annotations
...
_FEATURE_FLAGS_TEMPLATE_RESULT = """=== FILE: src/feature_flags/models.py ===
from __future__ import annotations
...
=== END FILE ===
=== FILE: src/feature_flags/evaluator.py ===
from __future__ import annotations
...
_FIXTURE_PAYLOADS = {
    "bookmarks_app_template": _BOOKMARKS_APP_TEMPLATE_RESULT,
    "project_template": _PROJECT_TEMPLATE_RESULT,
    "feature_flags_template": _FEATURE_FLAGS_TEMPLATE_RESULT,
}


def fixture_payload_for_task(task_id: str) -> str:
    try:
        return _FIXTURE_PAYLOADS[task_id]
    except KeyError as exc:
        raise ValueError(
            f"No deterministic V3 fixture payload is registered for task_id={task_id!r}."
        ) from exc


__all__ = ["fixture_payload_for_task"]
