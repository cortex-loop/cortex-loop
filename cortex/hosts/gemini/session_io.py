...
_PRE_EXPECTATION_LEDGER_CONTROL_RESIDUE_KEYS = (
    "last_budget_band",
    "last_commitment_result_summary",
    "last_realization_feedback",
    "feedback_window",
...
class GeminiRuntimeSessionArtifact:
    ...
    def __post_init__(self) -> None:
        ...
        if any(
            ...
            raise ValueError(
                "GeminiRuntimeSessionArtifact.continuity_reminders must contain only non-empty values after trimming."
            )
        ...
        if not isinstance(self.expectation_ledger, ExpectationLedger):
            ...
            raise TypeError(
                "GeminiRuntimeSessionArtifact.expectation_ledger must be "
...
def parse_gemini_runtime_session_artifact(
    ...
    artifact = GeminiRuntimeSessionArtifact(
        ...
        continuity_reminders=_continuity_reminders_tuple(
            ...
            "GeminiRuntimeSessionArtifact.continuity_truth.continuity_reminders",
        ),
...
def _require_continuity_truth_keys(payload: Mapping[str, Any]) -> None:
    ...
    raise ValueError(
        "GeminiRuntimeSessionArtifact.continuity_truth keys must be exactly "
...
def _require_control_residue_keys(payload: Mapping[str, Any]) -> None:
    ...
    if actual_keys in (
        ...
        return
    expected = (
        f"{_CONTROL_RESIDUE_KEYS}, {_PRE_EXPECTATION_LEDGER_CONTROL_RESIDUE_KEYS}, "
