...
from .runtime import OpenAIRuntimeSession, run_openai_runtime_step
from .cli import build_openai_cli_record
from .ingress import parse_openai_host_event_envelope
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python3 -m cortex.hosts.openai.ingress_cli",
