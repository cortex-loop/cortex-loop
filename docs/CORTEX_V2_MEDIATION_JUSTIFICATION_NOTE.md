...
| better host-specialized realization | Three reference-only mediation-specific host-realization pairs are now recorded and three Gemini-only pairs are now recorded, but OpenAI remains baseline-only and the package remains too narrow. | insufficient evidence |
