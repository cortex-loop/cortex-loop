...
| better host-specialized realization | Three reference-only mediation-specific host-realization pairs are now recorded, three Gemini-only pairs are now recorded, and one OpenAI-only pair is now recorded, but OpenAI remains below threshold and the package remains too narrow. | insufficient evidence |
