...
- `python3 -m experimental.runtime.claude_service`
...
- `ClaudeServiceState`, `handle_claude_service_request()`, `export_claude_service_session()`, `import_claude_service_session()`, and `python3 -m experimental.runtime.claude_service` are now landed `A3` surfaces, implemented at G1 proof head `fe33a7e`
