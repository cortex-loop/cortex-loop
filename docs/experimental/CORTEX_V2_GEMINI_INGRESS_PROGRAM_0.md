...
- `python3 -m experimental.runtime.gemini_ingress_cli`
...
- `python3 -m experimental.runtime.gemini_ingress_cli` now drives the current-line `G1` runtime shell from raw transcript records
