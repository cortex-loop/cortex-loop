...
- that post-closeout path may still explicitly include a Claude/Anthropic host-parity train before any later multi-host live validation train when the workstream promotes it.
