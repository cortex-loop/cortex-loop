# scenario_branch_reference_01__baseline_non_mediated__run_003
...
- run_id: `reference_branch_baseline_run_003`
- paired_episode_set_id: `pair_reference_branch_003`
...
- event_trace_refs: `reference-branch-003-step-1:ApprovalRequest/open, reference-branch-003-step-2:ApprovalRequest/suspend, reference-branch-003-step-3:ApprovalRequest/resume, reference-branch-003-step-4:ApprovalResult/merge`
- contradiction_refs: `reference-branch-artifact-check:reference branch artifact review remained partially unresolved`
- degradation_refs: `reference-branch-partial-003`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_reference_branch_003`. It is deterministic branch-discipline evidence only and does not by itself justify mediation.
