# scenario_burden_reference_01__baseline_non_mediated__run_001
...
- run_id: `reference_burden_baseline_run_001`
- paired_episode_set_id: `pair_reference_burden_001`
...
- event_trace_refs: `reference-burden-step-1:ContextLoad/observe, reference-burden-step-2:ApprovalRequest/check, reference-burden-step-3:ApprovalResult/resolve`
- contradiction_refs: `reference-burden-check:reference burden evidence remained partially withheld`
- degradation_refs: `reference-burden-partial`
- aux_burden_refs_if_present: `docs/lab/mediation_evidence/reference/scenario_burden_reference_01__baseline_non_mediated__run_001__aux_burden.md`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_reference_burden_001`. It is deterministic burden evidence only and does not by itself justify mediation.
