# scenario_burden_reference_01__baseline_non_mediated__run_002
...
- run_id: `reference_burden_baseline_run_002`
- paired_episode_set_id: `pair_reference_burden_002`
...
- event_trace_refs: `reference-burden-002-step-1:ContextLoad/observe, reference-burden-002-step-2:ApprovalRequest/check, reference-burden-002-step-3:ApprovalResult/resolve`
- contradiction_refs: `reference-burden-receipt-check:reference burden receipt remained partially withheld`
- degradation_refs: `reference-burden-partial-002`
- aux_burden_refs_if_present: `docs/lab/mediation_evidence/reference/scenario_burden_reference_01__baseline_non_mediated__run_002__aux_burden.md`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_reference_burden_002`. It is deterministic burden evidence only and does not by itself justify mediation.
