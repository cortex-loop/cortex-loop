# scenario_burden_openai_01__baseline_non_mediated__run_001
...
- run_id: `openai_burden_baseline_run_001`
- paired_episode_set_id: `pair_openai_burden_001`
...
- event_trace_refs: `openai-burden-step-1:response.output_text.delta/observe, openai-burden-step-2:response.output_text.delta/check, openai-burden-step-3:response.completed/resolve`
- contradiction_refs: `openai-burden-check:OpenAI burden evidence remained partially withheld`
- degradation_refs: `openai-burden-partial`
- aux_burden_refs_if_present: `docs/lab/mediation_evidence/openai/scenario_burden_openai_01__baseline_non_mediated__run_001__aux_burden.md`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_openai_burden_001`. It is deterministic burden evidence only and does not by itself justify mediation.
