# scenario_branch_openai_01__baseline_non_mediated__run_003
...
- run_id: `openai_branch_baseline_run_003`
- paired_episode_set_id: `pair_openai_branch_003`
...
- event_trace_refs: `openai-branch-003-step-1:response.output_text.delta/open, openai-branch-003-step-2:response.output_text.delta/suspend, openai-branch-003-step-3:response.output_text.delta/resume, openai-branch-003-step-4:response.completed/merge`
- contradiction_refs: `openai-branch-artifact-check:OpenAI branch artifact review remained partially unresolved`
- degradation_refs: `openai-branch-partial-003`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_openai_branch_003`. It is deterministic branch-discipline evidence only and does not by itself justify mediation.
