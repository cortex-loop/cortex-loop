# scenario_host_openai_01__baseline_non_mediated__run_002
...
- run_id: `openai_host_realization_baseline_run_002`
...
- event_trace_refs: `openai-lane:openai-host-packet-candidate-2`
...
- failure_tags: `none`
- notes: This packet is the baseline side of `pair_openai_host_002`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
