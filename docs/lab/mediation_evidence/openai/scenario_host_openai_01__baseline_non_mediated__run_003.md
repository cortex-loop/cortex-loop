# scenario_host_openai_01__baseline_non_mediated__run_003
...
- run_id: `openai_host_realization_baseline_run_003`
...
- event_trace_refs: `openai-lane:openai-host-packet-candidate-3`
...
- evaluation_packet_refs_if_present: `docs/experimental/CORTEX_V2_OPENAI_LANE_PACKET_EXAMPLE_0.md`
...
- failure_tags: `none`
- notes: This packet is the baseline side of `pair_openai_host_003`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
