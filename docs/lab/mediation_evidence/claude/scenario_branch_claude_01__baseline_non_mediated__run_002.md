# scenario_branch_claude_01__baseline_non_mediated__run_002
...
- run_id: `claude_branch_baseline_run_002`
- paired_episode_set_id: `pair_claude_branch_002`
...
- event_trace_refs: `claude-branch-002-step-1:content_block_delta/open, claude-branch-002-step-2:content_block_delta/suspend, claude-branch-002-step-3:content_block_delta/resume, claude-branch-002-step-4:message_stop/merge`
- contradiction_refs: `claude-branch-receipt-check:Claude branch receipt review remained partially unresolved`
- degradation_refs: `claude-branch-partial-002`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_claude_branch_002`. It is deterministic branch-discipline evidence only and does not by itself justify mediation.
