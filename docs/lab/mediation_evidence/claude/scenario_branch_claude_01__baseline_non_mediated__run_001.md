# scenario_branch_claude_01__baseline_non_mediated__run_001
...
- run_id: `claude_branch_baseline_run_001`
- paired_episode_set_id: `pair_claude_branch_001`
...
- event_trace_refs: `claude-branch-step-1:content_block_delta/open, claude-branch-step-2:content_block_delta/suspend, claude-branch-step-3:content_block_delta/resume, claude-branch-step-4:message_stop/merge`
- contradiction_refs: `claude-branch-check:Claude branch review remained partially unresolved`
- degradation_refs: `claude-branch-partial`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_claude_branch_001`. It is deterministic branch-discipline evidence only and does not by itself justify mediation.
