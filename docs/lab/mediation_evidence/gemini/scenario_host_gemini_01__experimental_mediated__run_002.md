# scenario_host_gemini_01__experimental_mediated__run_002
...
- run_id: `gemini_host_realization_mediated_run_002`
...
- starting_request_or_event: `content.delta` candidate-bearing turn on `gemini-host-packet-session-2` followed by `interaction.complete` with `commitment_id=gemini-host-packet-commit-2`
- host_surface: Gemini-host opportunity selection plus candidate-bearing continuation and commitment-to-eval-packet publication path
- declared_scenario_goal: evaluate whether mediation produces any Gemini-host realization lift without adding burden or branch churn
- bounded_environment_or_approval_context: Gemini-host candidate-bearing plus commitment/publication path with lawful provenance, contradiction-preserving degradation handling, the committed Gemini-lane packet/publication surface, and a bounded host-opportunity set containing `mcp.query`
...
- event_trace_refs: `gemini-mediated-lane:gemini-host-packet-candidate-2`
- contradiction_refs: `gemini-host-receipt-check:Gemini structured query result omitted one confirmation field`
- degradation_refs: `gemini-host-publication-partial-002`
- aux_burden_refs_if_present: none
- evaluation_packet_refs_if_present: `docs/experimental/CORTEX_V2_GEMINI_MEDIATED_LANE_PACKET_EXAMPLE_0.md`
...
- failure_tags: `none`
- notes: This packet is the mediated side of `pair_gemini_host_002`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
