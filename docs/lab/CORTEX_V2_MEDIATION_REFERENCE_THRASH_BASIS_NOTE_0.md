...
- committed packet docs:
  - `docs/lab/mediation_evidence/reference/scenario_thrash_reference_01__baseline_non_mediated__run_001.md`
  - `docs/lab/mediation_evidence/reference/scenario_thrash_reference_01__baseline_non_mediated__run_002.md`
  - `docs/lab/mediation_evidence/reference/scenario_thrash_reference_01__baseline_non_mediated__run_003.md`
- replication law note:
  - `docs/lab/CORTEX_V2_MEDIATION_REFERENCE_THRASH_REPLICATION_NOTE_0.md`
...
That baseline basis now supports the recorded three-pair reference-only experimental comparator set under `docs/lab/CORTEX_V2_MEDIATION_REFERENCE_THRASH_REPLICATION_NOTE_0.md`, including deterministic visible-burden derivation from the same committed steps, but this remains cell-local evidence only. The accepted package-level justification decision is recorded in `docs/lab/CORTEX_V2_MEDIATION_JUSTIFICATION_NOTE.md`, and this note does not by itself authorize implementation.
