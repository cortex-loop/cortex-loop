# scenario_host_openai_01__experimental_mediated__run_003
...
- run_id: `openai_host_realization_mediated_run_003`
...
- starting_request_or_event: `response.output_text.delta` candidate-bearing turn on `openai-host-packet-session-3` followed by `response.completed` with `commitment_id=openai-host-packet-commit-3`
...
- event_trace_refs: `openai-mediated-lane:openai-host-packet-candidate-3`
- contradiction_refs: `openai-host-artifact-check:OpenAI supporting artifact trace remained partial`
- degradation_refs: `openai-host-publication-partial-003`
- aux_burden_refs_if_present: none
- evaluation_packet_refs_if_present: `docs/CORTEX_V2_OPENAI_MEDIATED_LANE_PACKET_EXAMPLE_0.md`
...
- failure_tags: `none`
- notes: This packet is the mediated side of `pair_openai_host_003`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
