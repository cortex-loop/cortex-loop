# scenario_host_openai_01__experimental_mediated__run_001
...
- run_id: `openai_host_realization_mediated_run_001`
...
- event_trace_refs: `openai-mediated-lane:openai-host-packet-candidate-1`
...
- failure_tags: `none`
- notes: This packet is the mediated side of `pair_openai_host_001`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
