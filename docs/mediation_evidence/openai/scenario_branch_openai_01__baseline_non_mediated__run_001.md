# scenario_branch_openai_01__baseline_non_mediated__run_001
...
- run_id: `openai_branch_baseline_run_001`
- paired_episode_set_id: `pair_openai_branch_001`
...
- event_trace_refs: `openai-branch-step-1:response.output_text.delta/open, openai-branch-step-2:response.output_text.delta/suspend, openai-branch-step-3:response.output_text.delta/resume, openai-branch-step-4:response.completed/merge`
- contradiction_refs: `openai-branch-check:OpenAI branch review remained partially unresolved`
- degradation_refs: `openai-branch-partial`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_openai_branch_001`. It is deterministic branch-discipline evidence only and does not by itself justify mediation.
