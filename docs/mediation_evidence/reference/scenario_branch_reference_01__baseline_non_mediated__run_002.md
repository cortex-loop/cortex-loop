# scenario_branch_reference_01__baseline_non_mediated__run_002
...
- run_id: `reference_branch_baseline_run_002`
- paired_episode_set_id: `pair_reference_branch_002`
...
- event_trace_refs: `reference-branch-002-step-1:ApprovalRequest/open, reference-branch-002-step-2:ApprovalRequest/suspend, reference-branch-002-step-3:ApprovalRequest/resume, reference-branch-002-step-4:ApprovalResult/merge`
- contradiction_refs: `reference-branch-receipt-check:reference branch receipt review remained partially unresolved`
- degradation_refs: `reference-branch-partial-002`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_reference_branch_002`. It is deterministic branch-discipline evidence only and does not by itself justify mediation.
