# scenario_host_reference_01__experimental_mediated__run_001
...
This committed run packet records the mediated side of the first recorded reference-host host-realization comparator pair for mediation evidence review.
...
- event_trace_refs: `reference-mediated-lane:commit-packet-1`
...
- evaluation_packet_refs_if_present: `docs/CORTEX_V2_REFERENCE_MEDIATED_LANE_PACKET_EXAMPLE_0.md`

## Lift-Axis Observations

### Reduced Thrashing

- observation: This mediated packet is part of one host-realization comparator pair, but it is not a branch-control comparison.
...
- failure_tags: `none`
- notes: This packet is the mediated side of `pair_reference_host_001`. One pair does not justify mediation; package-level evidence notes govern verdicts.

## Reviewer Note

- reviewer_note: This is experimental mediated evidence only within the first recorded reference host-realization pair. It remains reference-only, does not justify mediation, and package-level evidence notes govern any verdict.
