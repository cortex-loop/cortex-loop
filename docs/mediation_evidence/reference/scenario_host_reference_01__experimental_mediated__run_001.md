...
- failure_tags: `none`
- notes: This packet is the mediated side of `pair_reference_host_001`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
