# scenario_branch_claude_01__baseline_non_mediated__run_003
...
- run_id: `claude_branch_baseline_run_003`
- paired_episode_set_id: `pair_claude_branch_003`
...
- host_surface: Claude-host branch-review and commitment publication path with landed SRE branch carriers
...
- event_trace_refs: `claude-branch-003-step-1:content_block_delta/open, claude-branch-003-step-2:content_block_delta/suspend, claude-branch-003-step-3:content_block_delta/resume, claude-branch-003-step-4:message_stop/merge`
- contradiction_refs: `claude-branch-artifact-check:Claude branch artifact review remained partially unresolved`
- degradation_refs: `claude-branch-partial-003`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_claude_branch_003`. It is deterministic branch-discipline evidence only and does not by itself justify mediation.
