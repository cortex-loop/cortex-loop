...
- `scenario_host_reference_01` remains baseline-only pending the admissibility audit recorded in `docs/CORTEX_V2_MEDIATION_REFERENCE_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md`.
