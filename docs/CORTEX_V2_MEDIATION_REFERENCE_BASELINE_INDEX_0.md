...
- `scenario_host_reference_01` is now the canonical baseline anchor for the counted three-pair reference host-realization series, governed by `docs/CORTEX_V2_MEDIATION_REFERENCE_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md` and `docs/CORTEX_V2_MEDIATION_REFERENCE_HOST_REALIZATION_REPLICATION_NOTE_0.md`.
