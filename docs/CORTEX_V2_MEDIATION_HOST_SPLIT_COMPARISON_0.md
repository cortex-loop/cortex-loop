...
| scenario_host_gemini_01 | 0 | Gemini host-realization remains intentionally unpaired pending the admissibility audit for a lawful host-facing publication surface. | none | insufficient | none | See `docs/CORTEX_V2_MEDIATION_GEMINI_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md`; no committed Gemini host-realization baseline anchor or paired run is recorded yet. |
...
| scenario_host_openai_01 | 0 | OpenAI host-realization remains intentionally unpaired pending the admissibility audit for a lawful host-facing publication surface. | none | insufficient | none | See `docs/CORTEX_V2_MEDIATION_OPENAI_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md`; no committed OpenAI host-realization baseline anchor or paired run is recorded yet. |
