...
| scenario_host_openai_01 | openai | 1 | passed | none | none | insufficient | pair_openai_host_001 | One OpenAI-only host-realization pair preserves the same certified completion class and truth boundary, but no lower-burden evidence is committed yet. |
