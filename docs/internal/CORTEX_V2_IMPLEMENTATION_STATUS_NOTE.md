...
It does not track later candidate or post-closeout mediation evidence; use `docs/internal/CORTEX_V2_ACTIVE_WORKSTREAM.md` and `docs/lab/CORTEX_V2_MEDIATION_JUSTIFICATION_NOTE.md` for that later accepted branch truth.
...
- The current refreshed live-model baseline is recorded in `docs/internal/CORTEX_V2_ACTIVE_WORKSTREAM.md` on the accepted local `main` line.
...
- The current accepted mediation-justification decision is recorded in `docs/lab/CORTEX_V2_MEDIATION_JUSTIFICATION_NOTE.md`.
...
- baseline recorded in `docs/lab/CORTEX_V2_COVERAGE_BASELINE_NOTE_0.md`
...
- use `docs/internal/CORTEX_V2_LOCAL_VERIFICATION.md` as the current source of truth for the canonical bundle, smoke bundle, and evidence revalidation entry points
...
In this maintainer workspace, future seam-parent truth is recorded in `docs/internal/CORTEX_V2_ACTIVE_WORKSTREAM.md`; do not hardcode a separate accepted workflow baseline here.
