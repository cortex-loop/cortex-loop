...
- `scenario_host_gemini_01` is now baseline-only and grounded in the committed Gemini packet/publication example recorded in `docs/CORTEX_V2_GEMINI_LANE_PACKET_EXAMPLE_0.md`; comparator admissibility remains constrained by `docs/CORTEX_V2_MEDIATION_GEMINI_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| gemini_host_realization_baseline_run_001 | scenario_host_gemini_01 | gemini | baseline_non_mediated | pending_pair_gemini_host_001 | baseline_packet_committed | docs/mediation_evidence/gemini/scenario_host_gemini_01__baseline_non_mediated__run_001.md | tests/integration/test_gemini_lane_packet_example.py::test_gemini_lane_current_pair_packet_example_matches_committed_doc | none | Baseline-only Gemini packet/publication anchor grounded in the committed Gemini-lane example. Comparator admissibility remains constrained by `docs/CORTEX_V2_MEDIATION_GEMINI_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md`. |
