...
| `R4` reference closed-loop feedback and latched-brake slice | `docs/CORTEX_V2_REFERENCE_FEEDBACK_PROGRAM_0.md` | `R4B` | open | the next bounded runtime program is opened from the clean corrected reference shell; it is limited to last-step realization feedback, a top-level control ledger, and latched-brake enforcement |
