...
- `docs/CORTEX_V2_ACTIVE_WORKSTREAM.md` now records the active L4 automation auth-alignment and service-lane live-proof seam after the landed operator-only audit.
