...
- `docs/CORTEX_V2_ACTIVE_WORKSTREAM.md` now records the bounded K train as landed, records `N2` as blocked pending a capable machine, and records `M2`, `J1`, `J2`, and `J3` as landed on `main`, with bounded experimental mediation-seam planning as the next lawful move.
