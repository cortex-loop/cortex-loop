...
- `docs/CORTEX_V2_ACTIVE_WORKSTREAM.md` now records the current L2c Claude/Gemini hook-backed operator follow-on seam inside the signed-in-first live-testing environment.
