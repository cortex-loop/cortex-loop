...
| reference-host live runtime session carrier with active-track continuity state and last-step feedback persistence | `ReferenceRuntimeSession` | `cortex/runtime/reference.py` | `test_reference_runtime_step.py::test_reference_runtime_session_tracks_minimum_live_state` + `test_reference_runtime_step.py::test_reference_runtime_step_propagates_session_rejection_feedback_into_next_event_pressure` + `test_reference_runtime_continuity.py::test_reference_runtime_cli_preserves_open_suspend_resume_merge_continuity_in_one_session` | landed |
| reference-host runtime step result carrier with selected-family truth and realized-family truth | `ReferenceRuntimeStepResult` | `cortex/runtime/reference.py` | `test_reference_runtime_step.py::test_reference_runtime_step_result_surfaces_cheap_reference_event_without_commitment_kind` + `test_reference_runtime_step.py::test_reference_runtime_step_result_certifies_full_commitment_when_runtime_payload_supplies_artifact_ref` + `test_reference_runtime_step.py::test_reference_runtime_step_enforces_latched_brake_to_check_when_evidence_dominates` | landed |
