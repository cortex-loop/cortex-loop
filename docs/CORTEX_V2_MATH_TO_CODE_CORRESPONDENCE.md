...
| compact executive policy view derived from summary and modulator state | `ExecutivePolicyView` + `build_executive_policy_view()` | `cortex/sre/policy_view.py` | `test_sre_policy_view.py::test_policy_view_switch_margin_changes_with_focus_and_explore` + `test_sre_policy_view.py::test_policy_view_allows_extra_read_pass_at_explicit_threshold` + `test_sre_policy_view.py::test_policy_view_bounds_numeric_fields` | landed |
