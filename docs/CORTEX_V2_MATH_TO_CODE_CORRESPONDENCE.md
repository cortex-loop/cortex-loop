...
| deterministic verified-work model-input packer over the user task plus bounded read-only bookmarks workspace context | `build_verified_work_input_text()` | `cortex/runtime/verified_work_runtime.py` | `test_verified_work_runtime.py::test_build_verified_work_input_text_attaches_workspace_context` + `test_openai_host_control.py::test_run_openai_host_control_verified_work_attaches_workspace_context_to_first_attempt` | landed |
| deterministic verified-work protocol parser plus bounded bookmarks verifier profile | `verify_verified_work_result()` | `cortex/runtime/verified_work_runtime.py` | `test_verified_work_runtime.py::test_verify_verified_work_result_rejects_unapproved_path` + `test_verified_work_runtime.py::test_verify_verified_work_result_preserves_blocked_missing_info` + `test_verified_work_runtime.py::test_verify_verified_work_result_ignores_blank_lines_between_file_blocks` + `test_verified_work_runtime.py::test_verify_verified_work_result_accepts_passing_submission` | landed |
