...
| OpenAI host-runtime control ledger carrier with nested executive allocation diagnostics | `OpenAIControlLedger` | `cortex/runtime/openai.py` | `test_openai_runtime_cli.py::test_openai_runtime_cli_reads_documented_raw_events_and_preserves_host_name` | landed |
