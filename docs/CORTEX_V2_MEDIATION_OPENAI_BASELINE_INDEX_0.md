...
- `scenario_host_openai_01` is now the canonical baseline anchor for the counted OpenAI host-realization paired-run series, grounded in the committed OpenAI packet/publication example recorded in `docs/CORTEX_V2_OPENAI_LANE_PACKET_EXAMPLE_0.md`; admissibility and fairness remain constrained by `docs/CORTEX_V2_MEDIATION_OPENAI_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md` and `docs/CORTEX_V2_MEDIATION_OPENAI_HOST_REALIZATION_REPLICATION_NOTE_0.md`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| openai_host_realization_baseline_run_001 | scenario_host_openai_01 | openai | baseline_non_mediated | pair_openai_host_001 | baseline_packet_committed | docs/mediation_evidence/openai/scenario_host_openai_01__baseline_non_mediated__run_001.md | tests/integration/test_openai_lane_packet_example.py::test_openai_lane_current_pair_packet_example_matches_committed_doc | none | Canonical baseline anchor for the counted OpenAI host-realization paired-run series, grounded in the committed OpenAI-lane example. Three paired runs are now recorded through `docs/CORTEX_V2_MEDIATION_PAIRED_RUN_LEDGER_0.md`, and admissibility/fairness remain constrained by `docs/CORTEX_V2_MEDIATION_OPENAI_HOST_REALIZATION_ADMISSIBILITY_NOTE_0.md` and `docs/CORTEX_V2_MEDIATION_OPENAI_HOST_REALIZATION_REPLICATION_NOTE_0.md`. |
