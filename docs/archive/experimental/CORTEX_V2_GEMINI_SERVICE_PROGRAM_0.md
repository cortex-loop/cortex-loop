...
- `python3 -m cortex.hosts.gemini.service`
...
- `GeminiServiceState`, `handle_gemini_service_request()`, `export_gemini_service_session()`, `import_gemini_service_session()`, and `python3 -m cortex.hosts.gemini.service` are now landed `G3` surfaces, implemented at G1 proof head `fe33a7e`
