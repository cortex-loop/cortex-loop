...
- `python3 -m cortex.hosts.claude.ingress_cli`
...
- `python3 -m cortex.hosts.claude.ingress_cli` now drives the current-line `A1` runtime shell from raw transcript records
