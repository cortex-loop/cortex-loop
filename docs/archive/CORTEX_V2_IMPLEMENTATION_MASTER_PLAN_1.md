...
| v1 source | Keep | v2 destination | Port mode |
| --- | --- | --- | --- |
| `stop_signals.py` | attempt relation taxonomy (`identical`, `reduced`, `expanded`, `substituted`) | `cortex/sre/branching.py` or `cortex/sre/policy.py` | rewrite |
...
#### Example seam
- Land `docs/CORTEX_V2_IMPLEMENTATION_READINESS_NOTE.md` and optionally a tiny `support.py` / `roles.py` type scaffold that reflects the note.
...
- `cortex/sre/allocation.py`
- `cortex/sre/opportunities.py`
