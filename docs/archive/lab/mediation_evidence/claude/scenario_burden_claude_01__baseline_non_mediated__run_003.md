# scenario_burden_claude_01__baseline_non_mediated__run_003
...
- run_id: `claude_burden_baseline_run_003`
- paired_episode_set_id: `pair_claude_burden_003`
...
- event_trace_refs: `claude-burden-003-step-1:content_block_delta/observe, claude-burden-003-step-2:content_block_delta/check, claude-burden-003-step-3:message_stop/resolve`
- contradiction_refs: `claude-burden-artifact-check:Claude burden artifact remained partially withheld`
- degradation_refs: `claude-burden-partial-003`
- aux_burden_refs_if_present: `docs/lab/mediation_evidence/claude/scenario_burden_claude_01__baseline_non_mediated__run_003__aux_burden.md`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_claude_burden_003`. It is deterministic burden evidence only and does not by itself justify mediation.
