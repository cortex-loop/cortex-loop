# scenario_burden_claude_01__baseline_non_mediated__run_001
...
- run_id: `claude_burden_baseline_run_001`
- paired_episode_set_id: `pair_claude_burden_001`
...
- event_trace_refs: `claude-burden-step-1:content_block_delta/observe, claude-burden-step-2:content_block_delta/check, claude-burden-step-3:message_stop/resolve`
- contradiction_refs: `claude-burden-check:Claude burden evidence remained partially withheld`
- degradation_refs: `claude-burden-partial`
- aux_burden_refs_if_present: `docs/lab/mediation_evidence/claude/scenario_burden_claude_01__baseline_non_mediated__run_001__aux_burden.md`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_claude_burden_001`. It is deterministic burden evidence only and does not by itself justify mediation.
