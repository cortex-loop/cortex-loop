# scenario_burden_openai_01__baseline_non_mediated__run_002
...
- run_id: `openai_burden_baseline_run_002`
- paired_episode_set_id: `pair_openai_burden_002`
...
- event_trace_refs: `openai-burden-002-step-1:response.output_text.delta/observe, openai-burden-002-step-2:response.output_text.delta/check, openai-burden-002-step-3:response.completed/resolve`
- contradiction_refs: `openai-burden-receipt-check:OpenAI burden receipt remained partially withheld`
- degradation_refs: `openai-burden-partial-002`
- aux_burden_refs_if_present: `docs/lab/mediation_evidence/openai/scenario_burden_openai_01__baseline_non_mediated__run_002__aux_burden.md`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_openai_burden_002`. It is deterministic burden evidence only and does not by itself justify mediation.
