# scenario_burden_openai_01__baseline_non_mediated__run_003
...
- run_id: `openai_burden_baseline_run_003`
- paired_episode_set_id: `pair_openai_burden_003`
...
- host_surface: OpenAI-host observe/check/resolve path with the same commitment boundary and no thrash-style branch churn
...
- event_trace_refs: `openai-burden-003-step-1:response.output_text.delta/observe, openai-burden-003-step-2:response.output_text.delta/check, openai-burden-003-step-3:response.completed/resolve`
- contradiction_refs: `openai-burden-artifact-check:OpenAI burden artifact remained partially withheld`
- degradation_refs: `openai-burden-partial-003`
- aux_burden_refs_if_present: `docs/lab/mediation_evidence/openai/scenario_burden_openai_01__baseline_non_mediated__run_003__aux_burden.md`
...
- failure_tags: `none`
- notes: This packet is one side of `pair_openai_burden_003`. It is deterministic burden evidence only and does not by itself justify mediation.
