# scenario_host_gemini_01__experimental_mediated__run_003
...
- run_id: `gemini_host_realization_mediated_run_003`
...
- starting_request_or_event: `content.delta` candidate-bearing turn on `gemini-host-packet-session-3` followed by `interaction.complete` with `commitment_id=gemini-host-packet-commit-3`
...
- event_trace_refs: `gemini-mediated-lane:gemini-host-packet-candidate-3`
- contradiction_refs: `gemini-host-artifact-check:Gemini supporting artifact trace remained partial`
- degradation_refs: `gemini-host-publication-partial-003`
...
- failure_tags: `none`
- notes: This packet is the mediated side of `pair_gemini_host_003`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
