# scenario_host_gemini_01__baseline_non_mediated__run_003
...
- run_id: `gemini_host_realization_baseline_run_003`
...
- event_trace_refs: `gemini-lane:gemini-host-packet-candidate-3`
...
- failure_tags: `none`
- notes: This packet is the baseline side of `pair_gemini_host_003`. A single packet does not justify mediation; package-level evidence notes govern verdicts.
