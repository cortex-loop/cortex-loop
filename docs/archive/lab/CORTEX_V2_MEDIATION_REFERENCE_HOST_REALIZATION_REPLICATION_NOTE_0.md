...
Three reference-only pairs are real host-realization evidence, and the accepted package-level justification decision is recorded in `docs/lab/CORTEX_V2_MEDIATION_JUSTIFICATION_NOTE.md`. This replication note does not by itself authorize implementation.
