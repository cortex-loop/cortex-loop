...
| time-separated AUX corpus runner over source publication and later target evaluation | `evaluate_aux_support_corpus()` | `cortex/aux/evaluation.py` | `test_aux_corpus.py::test_evaluate_aux_support_corpus_reports_time_separated_lift_and_acceptance` + `test_aux_corpus.py::test_evaluate_aux_support_corpus_can_recommend_prune_candidate_for_weak_cases` | landed |
