...
- `docs/lab/CORTEX_V2_EXECUTIVE_LIVE_OUTCOME_PROGRAM_0.md`
- `docs/internal/CORTEX_V2_COMPUTED_EXECUTIVE_LOOP_PROGRAM_0.md`
...
- `python3 -m cortex.hosts.openai.service`
